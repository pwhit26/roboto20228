...
public class icyTele extends LinearOpMode {
    ...
    boolean xLast, bLast, bPressable, yPressable, aLast, aPressable, UbumpLast, rbumpPressable, b1Last, b1Pressable, x1Last, x1Pressable, DbumpLast;
            ...
            if (ll != null && ll.isValid()) {
                ...
                for (LLResultTypes.FiducialResult fr : fiducials) {
                    ...
                    if (tagId == 20) {
                        ...
                        double txRad = Math.toRadians(ll.getTx() - 3.0);
